...
import  requests
from .utils import champ_json,get_world_tour,get_champ_json
...
def scrape():
    ...
    tour = get_world_tour(world_tour)
    temp_json = get_champ_json(tour)
    ...
    for k,v in temp_json.items():
        ...
        # comp = Competition.objects.get_or_create(champ=champ,description=champ_desc,location=loc,
