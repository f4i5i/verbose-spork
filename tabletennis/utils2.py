        ...
        if r:
            for j in range(len(r)):
                ...
                if isTeam_home.bit_length() > 1 :
                    ...
                    ply1_home = Player.objects.get_or_create(name=player1_home,org=c_home1)
                    ply2_home = Player.objects.get_or_create(name=player2_home,org=c_home2)

                    ply1_away = Player.objects.get_or_create(name=player1_away,org=c_away1)
                    ply2_away = Player.objects.get_or_create(name=player2_away,org=c_away2)
                    print(ply1_home)
                    print(ply1_away)
                    ...
                    player_home = Player.objects.get_or_create(name=home,org=c_name_home)
                    player_away = Player.objects.get_or_create(name=away,org=c_name_away)
